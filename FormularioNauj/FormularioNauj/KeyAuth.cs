        ...
        public async Task enable2fa(string code = null)
        {
            ...
            if (json.success)
            {
                if (code == null) // First time enabling 2FA, no code provided
                {
                    ...
                    System.Windows.Forms.MessageBox.Show($"Your 2FA Secret Code has been copied to your clipboard! \n\n: {json.twoFactor.SecretCode}", "2FA Secret");

                }
                else // Code provided by the user
                {
                    System.Windows.Forms.MessageBox.Show("2FA has been successfully enabled!", "2FA Setup");
                }
            }
            else
            {
